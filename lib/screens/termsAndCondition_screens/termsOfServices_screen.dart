...
you, whether personally or on behalf of an entity (“you”) and Success
Airlines App ("Company", “we”, “us”, or “our”), concerning your access
to and use of the http://www.success-airlines.com website as well as
...
States and have our registered office at 4817 Brentwood stair F road,
4817 F3, Fort Worth 76103. The Site provides an online marketplace for
the following goods, products, and/or services: educational lessons
...
users are required to accept and comply with these Terms of Use. You
agree that by accessing the Site and/or the Marketplace Offerings, you
...
parental permission to use the Site; (5) you will not access the Site
...
All Marketplace Offerings are subject to availability, and we cannot
guarantee that Marketplace Offerings will be in stock. Certain
Marketplace Offerings may be available exclusively online through the
Site. Such Marketplace Offerings may have limited quantities and are
...
of Use. You shall not: (1) except as permitted by applicable law,
...
Policy: https://app.termly.io/document/privacy-policy/bf877746-bfdd-47a8-aff4-e0524ec4f7c6.
...
the State of Texas applicable to agreements made and to be entirely
...
arbitration will take place in harris county, Texas. Except as
...
and federal courts located in harris county, Texas, and the Parties
...
BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE ONE (1)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title:
            SmallText(text: 'Terms of Services', color: Colors.black, size: 18),
        elevation: 0,
