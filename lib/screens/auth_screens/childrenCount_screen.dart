          ...
          child: GridView.count(
            ...
            children: [
              RoundedButton(
                ...
                textColor: age == ChildAge.age0_3 ? Colors.white : purpleColor,
              ),
              RoundedButton(
                onPressed: () {
                  setState(() {
                ...
                textColor: age == ChildAge.age4_6 ? Colors.white : purpleColor,
              ),
              RoundedButton(
                onPressed: () {
                  setState(() {
                ...
                textColor: age == ChildAge.age7_10 ? Colors.white : purpleColor,
              ),
              RoundedButton(
                onPressed: () {
                  setState(() {
                ...
                label: '11-13',
                radius: 15,
                bgColor: age == ChildAge.age11_13 ? purpleColor : Colors.white,
        ...
        RoundedButton(
          ...
          onPressed: !isAgree
              ...
              : () {
                  ...
                  Get.to(() => ReferralScreen(), arguments: widget.userDetails);
                },
        ),
      ]),
    );
